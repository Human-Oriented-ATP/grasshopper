...
tff('constraint_62', axiom, ~($lesseq(boom, 0))).
tff('constraint_63', axiom, ~($lesseq(size, boom))).
tff('constraint_64', axiom, getitem(landings(jumpso), boom)).
tff('constraint_65', axiom, getitem(mines, boom)).
