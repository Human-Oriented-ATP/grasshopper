...
tff('constraint_69', axiom, jumpsr = s(jumps_ih)).
tff('constraint_70', axiom, ![X:$int] : (~(getitem(landings(jumps_ih), X)) | ~(getitem(mines1, X)))).
tff('constraint_71', axiom, ($sum($sum(boom, $product(-1, length_c1(jumps_max))), 1) = 0 | getitem(landings(jumps_ih), $sum(boom, $product(-1, length_c1(jumps_max)))))).
tff('constraint_72', axiom, getitem(mines, boom)).
