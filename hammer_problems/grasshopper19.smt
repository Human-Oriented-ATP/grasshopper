...
(assert (! (forall ((jsb t_jump_set) (jsc t_jump_set) (jsa t_jump_set)) (= (subtract (jumpset_merge jsa jsb) (jumpset_merge jsa jsc)) (subtract_c1 jsb jsc))) :named constraint-49))
...
(assert (! (or (not (<= 0 (length_c2 mines00))) (not (<= (length_c2 mines00) (length_c2 mines1)))) :named constraint-75))
