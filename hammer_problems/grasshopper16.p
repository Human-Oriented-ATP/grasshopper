...
tff('constraint_49', axiom, ![Jsa:t_jump_set, Jsb:t_jump_set, Jsc:t_jump_set] : subtract(jumpset_merge(Jsa, Jsb), jumpset_merge(Jsa, Jsc)) = subtract_c1(Jsb, Jsc)).
...
tff('constraint_83', axiom, ~(length(subtract(jumpset_merge(jumpset_merge(jumpset_merge(s(jumps_ih0), jumpset_singleton(jumps_ih_mid)), jumpset_singleton(jumps_max)), s(jumps_ih1)), jumps)) = 0)).
