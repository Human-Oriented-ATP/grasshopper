...
tff('constraint_77', axiom, ($sum($sum(boom, $product(-1, length_c1(jumps_max))), 1) = 0 | getitem(landings(jumps_ih), $sum(boom, $product(-1, length_c1(jumps_max)))))).
tff('constraint_78', axiom, getitem(mines, boom)).
