...
(assert (! (forall ((jsa t_jump_set) (jsb t_jump_set) (jsc t_jump_set)) (= (subtract (jumpset_merge jsa jsb) (jumpset_merge jsa jsc)) (subtract_c1 jsb jsc))) :named constraint-49))
...
(assert (! (not (= (length (subtract (jumpset_merge (jumpset_singleton jumps_max) (s jumps_ih)) jumps)) 0)) :named constraint-77))
