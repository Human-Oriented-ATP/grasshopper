...
(assert (! (not (<= boom 0)) :named constraint-71))
(assert (! (not (<= size boom)) :named constraint-72))
(assert (! (or (= (+ boom (* (- 1) (length_c1 jumps_max)) 1) 0) (getitem (landings jumps_ih) (+ boom (* (- 1) (length_c1 jumps_max))))) :named constraint-73))
(assert (! (getitem mines boom) :named constraint-74))
