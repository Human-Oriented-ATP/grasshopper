...
(assert (! (forall ((ja t_jumps) (jb t_jumps) (jc t_jumps)) (= (jumps_concat (jumps_concat ja jb) jc) (jumps_concat ja (jumps_concat jb jc)))) :named constraint-2))
...
(assert (! (not (= (jumpset_merge (jumpset_merge (jumpset_singleton jumps_ih0) (jumpset_singleton jumps_max)) (s jumps_ihr)) jumps)) :named constraint-81))
