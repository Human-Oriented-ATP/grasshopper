...
(assert (! (= jumps_ih (jumps_concat (jumps_concat jumps_ih0 (jumps_singleton jumps_ih_mid)) jumps_ih1)) :named constraint-80))
(assert (! (<= (length (s jumps_ih0)) (+ (length_c2 mines10) 1)) :named constraint-81))
(assert (! (not (<= (+ (length (s jumps_ih0)) (length_c1 jumps_ih_mid)) (+ (length_c2 mines10) 1))) :named constraint-82))
(assert (! (or (getitem (landings jumps_ih0) boom) (= (+ boom (* (- 1) (length (s jumps_ih0))) (* (- 1) (length_c1 jumps_ih_mid)) 1) 0) (= (+ boom (* (- 1) (length (s jumps_ih0))) (* (- 1) (length_c1 jumps_ih_mid)) (* (- 1) (length_c1 jumps_max)) 1) 0) (getitem (landings jumps_ih1) (+ boom (* (- 1) (length (s jumps_ih0))) (* (- 1) (length_c1 jumps_ih_mid)) (* (- 1) (length_c1 jumps_max))))) :named constraint-83))
