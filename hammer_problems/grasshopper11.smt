...
(assert (! (not (getitem (landings jumps_ih) (length_c2 mines10))) :named constraint-73))
(assert (! (not (<= boom 0)) :named constraint-74))
(assert (! (not (<= size boom)) :named constraint-75))
(assert (! (or (= (+ boom (* (- 1) (length_c1 jumps_max)) 1) 0) (getitem (landings jumps_ih) (+ boom (* (- 1) (length_c1 jumps_max))))) :named constraint-76))
(assert (! (getitem mines boom) :named constraint-77))
