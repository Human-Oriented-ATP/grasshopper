...
(assert (! (forall ((jsc t_jump_set) (jsb t_jump_set) (jsa t_jump_set)) (= (jumpset_merge (jumpset_merge jsa jsb) jsc) (jumpset_merge jsa (jumpset_merge jsb jsc)))) :named constraint-6))
...
(assert (! (forall ((jx t_jump) (jsb t_jump_set) (jsa t_jump_set)) (or (not (nodup (jumpset_merge jsa jsb))) (not (contains jsa jx)) (not (contains jsb jx)))) :named constraint-34))
...
(assert (! (or (<= (number jumps) (number jumpsr)) (not (nodup jumpsr)) (not (= (length jumpsr) (+ (length_c2 mines_un) 1))) (<= (number jumpsr) (count mines_un))) :named constraint-78))
