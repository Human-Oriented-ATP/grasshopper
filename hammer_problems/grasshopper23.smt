...
(assert (! (not (= (length (subtract jumps (jumpset_merge (jumpset_merge (jumpset_singleton jumps_ih0) (jumpset_singleton jumps_max)) (s jumps_ihr)))) 0)) :named constraint-87))
