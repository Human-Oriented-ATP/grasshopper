...
tff('constraint_9', axiom, ![Mc:t_mine_field, Ma:t_mine_field, Mb:t_mine_field] : minefield_concat(minefield_concat(Ma, Mb), Mc) = minefield_concat(Ma, minefield_concat(Mb, Mc))).
...
tff('constraint_49', axiom, ![Jsa:t_jump_set, Jsc:t_jump_set, Jsb:t_jump_set] : subtract(jumpset_merge(Jsa, Jsb), jumpset_merge(Jsa, Jsc)) = subtract_c1(Jsb, Jsc)).
...
tff('constraint_87', axiom, ~(length(subtract(jumps, jumpset_merge(jumpset_merge(jumpset_singleton(jumps_ih0), jumpset_singleton(jumps_max)), s(jumps_ihr)))) = 0)).
