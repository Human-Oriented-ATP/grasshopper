...
tff('constraint_40', axiom, ![X:$int, Mb:t_mine_field, Ma:t_mine_field] : (getitem(minefield_concat(Ma, Mb), X) <=> (getitem(Ma, X) | getitem(Mb, $sum(X, $product(-1, length_c2(Ma))))))).
...
tff('constraint_86', axiom, $lesseq(number(s(jumps_ih)), 0)).
