...
tff('constraint_73', axiom, (~($lesseq(length_c2(mines1), length_c2(mines000))) | length_c2(mines_un) = length_c2(mines000))).
tff('constraint_74', axiom, (~($lesseq(length_c2(mines000), length_c2(mines1))) | length_c2(mines_un) = length_c2(mines1))).
...
tff('constraint_78', axiom, ($lesseq(number(jumps), number(jumpsr)) | ~(nodup(jumpsr)) | ~(length(jumpsr) = $sum(length_c2(mines_un), 1)) | $lesseq(number(jumpsr), count(mines_un)))).
