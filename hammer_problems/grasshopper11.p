...
tff('constraint_74', axiom, ~($lesseq(boom, 0))).
tff('constraint_75', axiom, ~($lesseq(size, boom))).
tff('constraint_76', axiom, ($sum($sum(boom, $product(-1, length_c1(jumps_max))), 1) = 0 | getitem(landings(jumps_ih), $sum(boom, $product(-1, length_c1(jumps_max)))))).
tff('constraint_77', axiom, getitem(mines, boom)).
