...
tff('constraint_83', axiom, ~(length(subtract(jumps, jumpset_merge(jumpset_merge(jumpset_merge(s(jumps_ih0), jumpset_singleton(jumps_ih_mid)), jumpset_singleton(jumps_max)), s(jumps_ih1)))) = 0)).
