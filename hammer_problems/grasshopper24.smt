...
(assert (! (or (= (+ boom (* (- 1) (length_c1 jumps_ih0)) 1) 0) (= (+ boom (* (- 1) (length_c1 jumps_ih0)) (* (- 1) (length_c1 jumps_max)) 1) 0) (getitem (landings jumps_ihr) (+ boom (* (- 1) (length_c1 jumps_ih0)) (* (- 1) (length_c1 jumps_max))))) :named constraint-87))
(assert (! (getitem mines boom) :named constraint-88))
