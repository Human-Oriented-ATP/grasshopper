...
(assert (! (forall ((jb t_jumps) (ja t_jumps) (jc t_jumps)) (= (jumps_concat (jumps_concat ja jb) jc) (jumps_concat ja (jumps_concat jb jc)))) :named constraint-2))
...
(assert (! (<= (number (s jumps_ih)) 0) :named constraint-80))
