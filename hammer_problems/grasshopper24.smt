...
(assert (! (or (not (<= (length_c2 mines1) (length_c2 mines000))) (= (length_c2 mines_un) (length_c2 mines000))) :named constraint-73))
(assert (! (or (not (<= (length_c2 mines000) (length_c2 mines1))) (= (length_c2 mines_un) (length_c2 mines1))) :named constraint-74))
