...
tff(subtract_type, type, subtract : (t_jump_set * t_jump_set) > t_jump_set).
tff(subtract_c1_type, type, subtract_c1 : (t_jump_set * t_jump_set) > t_jump_set).
tff(jumps_type, type, jumps : t_jump_set).
tff(size_type, type, size : $int).
tff(mines_type, type, mines : t_mine_field).
tff(jumps_max_type, type, jumps_max : t_jump).
tff(jumpsr_type, type, jumpsr : t_jump_set).
tff(mines0_type, type, mines0 : t_mine_field).
tff(mines1_type, type, mines1 : t_mine_field).
tff(mines00_type, type, mines00 : t_mine_field).
tff(mines01_type, type, mines01 : t_mine_field).
tff(mines10_type, type, mines10 : t_mine_field).
tff(mines11_type, type, mines11 : t_mine_field).
tff(mines_un_type, type, mines_un : t_mine_field).
...
tff('constraint_2', axiom, ![Jc:t_jumps, Jb:t_jumps, Ja:t_jumps] : jumps_concat(jumps_concat(Ja, Jb), Jc) = jumps_concat(Ja, jumps_concat(Jb, Jc))).
...
tff('constraint_9', axiom, ![Mc:t_mine_field, Mb:t_mine_field, Ma:t_mine_field] : minefield_concat(minefield_concat(Ma, Mb), Mc) = minefield_concat(Ma, minefield_concat(Mb, Mc))).
...
tff('constraint_41', axiom, ![X:$int, Jx:t_jump] : ~(getitem(jump_over(Jx), X))).
...
tff('constraint_44', axiom, ![Jsa:t_jump_set] : subtract(empty_jumpset, Jsa) = empty_jumpset).
tff('constraint_45', axiom, ![Jsa:t_jump_set] : subtract(Jsa, empty_jumpset) = Jsa).
tff('constraint_46', axiom, ![Jsa:t_jump_set] : subtract(Jsa, Jsa) = empty_jumpset).
tff('constraint_47', axiom, ![Jsa:t_jump_set, Jsb:t_jump_set] : subtract(Jsa, jumpset_merge(Jsa, Jsb)) = empty_jumpset).
tff('constraint_48', axiom, ![Jsa:t_jump_set, Jsb:t_jump_set] : subtract(jumpset_merge(Jsa, Jsb), Jsa) = Jsb).
tff('constraint_49', axiom, ![Jsc:t_jump_set, Jsa:t_jump_set, Jsb:t_jump_set] : subtract(jumpset_merge(Jsa, Jsb), jumpset_merge(Jsa, Jsc)) = subtract_c1(Jsb, Jsc)).
tff('constraint_50', axiom, ![X:t_jump] : ~($lesseq(length_c1(X), 0))).
tff('constraint_51', axiom, ![X:t_jump_set] : $lesseq(0, length(X))).
tff('constraint_52', axiom, ![X:t_jump_set] : $lesseq(0, number(X))).
tff('constraint_53', axiom, ![X:t_jump_set] : $lesseq(number(X), length(X))).
tff('constraint_54', axiom, ![X:t_jump_set] : (~(number(X) = 0) | length(X) = 0)).
tff('constraint_55', axiom, ![X:t_mine_field] : $lesseq(0, length_c2(X))).
tff('constraint_56', axiom, ![X:t_mine_field] : $lesseq(0, count(X))).
tff('constraint_57', axiom, ![X:t_mine_field] : $lesseq(count(X), length_c2(X))).
tff('constraint_58', axiom, ![A:t_mine_field, X:$int] : (~(getitem(A, X)) | $lesseq(0, X))).
tff('constraint_59', axiom, ![A:t_mine_field, X:$int] : (~(getitem(A, X)) | ~($lesseq(length_c2(A), X)))).
tff('constraint_60', axiom, ![A:t_mine_field, X:$int] : (~(getitem(A, X)) | ~($lesseq(count(A), 0)))).
tff('constraint_61', axiom, ![A:t_mine_field, X:$int] : (~($lesseq(length_c2(A), count(A))) | ~($lesseq(0, X)) | $lesseq(length_c2(A), X) | getitem(A, X))).
tff('constraint_62', axiom, nodup(jumps)).
tff('constraint_63', axiom, length(jumps) = $sum(size, 1)).
tff('constraint_64', axiom, length_c2(mines) = size).
tff('constraint_65', axiom, ~($lesseq(number(jumps), count(mines)))).
tff('constraint_66', axiom, jumps = jumpset_merge(jumpset_singleton(jumps_max), jumpsr)).
tff('constraint_67', axiom, ![X:t_jump] : (~(contains(jumpsr, X)) | $lesseq(length_c1(X), length_c1(jumps_max)))).
tff('constraint_68', axiom, ~(number(jumpsr) = 0)).
tff('constraint_69', axiom, mines = minefield_concat(mines0, mines1)).
tff('constraint_70', axiom, length_c2(mines0) = length_c1(jumps_max)).
tff('constraint_71', axiom, mines0 = minefield_concat(mines00, mines01)).
tff('constraint_72', axiom, length_c2(mines00) = $sum(length_c1(jumps_max), -1)).
tff('constraint_73', axiom, getitem(mines01, 0)).
tff('constraint_74', axiom, $lesseq(length_c2(mines00), length_c2(mines1))).
tff('constraint_75', axiom, mines1 = minefield_concat(mines10, mines11)).
tff('constraint_76', axiom, length_c2(mines10) = length_c2(mines00)).
tff('constraint_77', axiom, ![X:$int] : (~(getitem(mines00, X)) | getitem(mines_un, X))).
tff('constraint_78', axiom, ![X:$int] : (~(getitem(mines10, X)) | getitem(mines_un, X))).
tff('constraint_79', axiom, (~($lesseq(length_c2(mines10), length_c2(mines00))) | length_c2(mines_un) = length_c2(mines00))).
tff('constraint_80', axiom, (~($lesseq(length_c2(mines00), length_c2(mines10))) | length_c2(mines_un) = length_c2(mines10))).
tff('constraint_81', axiom, $lesseq(count(mines00), count(mines_un))).
tff('constraint_82', axiom, $lesseq(count(mines10), count(mines_un))).
tff('constraint_83', axiom, $lesseq(count(mines_un), $sum(count(mines00), count(mines10)))).
tff('constraint_84', axiom, jumpsr = s(jumps_ih)).
tff('constraint_85', axiom, ![X:$int] : (~(getitem(landings(jumps_ih), X)) | (~(getitem(mines_un, X)) & ~(getitem(mines11, $sum(X, $product(-1, length_c2(mines_un)))))))).
tff('constraint_86', axiom, jumps_ih = jumps_concat(jumps_singleton(jumps_ih0), jumps_ihr)).
tff('constraint_87', axiom, ($sum($sum(boom, $product(-1, length_c1(jumps_ih0))), 1) = 0 | $sum($sum($sum(boom, $product(-1, length_c1(jumps_ih0))), $product(-1, length_c1(jumps_max))), 1) = 0 | getitem(landings(jumps_ihr), $sum($sum(boom, $product(-1, length_c1(jumps_ih0))), $product(-1, length_c1(jumps_max)))))).
tff('constraint_88', axiom, getitem(mines, boom)).
