...
(assert (! (or (<= (number jumps) (number jumpsr)) (not (nodup jumpsr)) (not (= (length jumpsr) (+ (length_c2 mines_un) (length_c2 mines11) 1))) (<= (number jumpsr) (+ (count mines_un) (count mines11)))) :named constraint-84))
