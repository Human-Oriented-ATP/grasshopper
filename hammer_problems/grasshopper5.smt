...
(assert (! (forall ((mb t_mine_field) (mc t_mine_field) (ma t_mine_field)) (= (minefield_concat (minefield_concat ma mb) mc) (minefield_concat ma (minefield_concat mb mc)))) :named constraint-9))
