...
(assert (! (forall ((jsc t_jump_set) (jsb t_jump_set) (jsa t_jump_set)) (= (subtract (jumpset_merge jsa jsb) (jumpset_merge jsa jsc)) (subtract_c1 jsb jsc))) :named constraint-49))
...
(assert (! (or (= (+ boom (* (- 1) (length_c1 jumps_max)) 1) 0) (getitem (landings jumps_ih) (+ boom (* (- 1) (length_c1 jumps_max))))) :named constraint-77))
