...
(assert (! (or (<= (number jumps) (number jumpsr)) (not (nodup jumpsr)) (not (= (length jumpsr) (+ (length_c2 mines10) (length_c2 mines11) 2))) (<= (number jumpsr) (+ (count mines10) (count mines11)))) :named constraint-71))
