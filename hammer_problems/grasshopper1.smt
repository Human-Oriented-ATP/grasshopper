...
(assert (! (not (<= boom 0)) :named constraint-62))
(assert (! (not (<= size boom)) :named constraint-63))
(assert (! (getitem (landings jumpso) boom) :named constraint-64))
(assert (! (getitem mines boom) :named constraint-65))
