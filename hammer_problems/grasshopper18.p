...
tff(jumps_ih0_type, type, jumps_ih0 : t_jumps).
tff(jumps_ih_mid_type, type, jumps_ih_mid : t_jump).
tff(jumps_ih1_type, type, jumps_ih1 : t_jumps).
...
tff('constraint_49', axiom, ![Jsb:t_jump_set, Jsc:t_jump_set, Jsa:t_jump_set] : subtract(jumpset_merge(Jsa, Jsb), jumpset_merge(Jsa, Jsc)) = subtract_c1(Jsb, Jsc)).
...
tff('constraint_74', axiom, $lesseq(number(jumpsr), count(mines1))).
tff('constraint_75', axiom, mines1 = minefield_concat(minefield_concat(mines10, minefield_singleton($true)), mines11)).
tff('constraint_76', axiom, count(mines10) = 0).
tff('constraint_77', axiom, jumpsr = s(jumps_ih)).
tff('constraint_78', axiom, ![X:$int] : (~(getitem(landings(jumps_ih), X)) | (~(getitem(mines10, X)) & ~(getitem(mines11, $sum($sum(X, $product(-1, length_c2(mines10))), -1)))))).
tff('constraint_79', axiom, getitem(landings(jumps_ih), length_c2(mines10))).
tff('constraint_80', axiom, jumps_ih = jumps_concat(jumps_concat(jumps_ih0, jumps_singleton(jumps_ih_mid)), jumps_ih1)).
tff('constraint_81', axiom, $lesseq(length(s(jumps_ih0)), $sum(length_c2(mines10), 1))).
tff('constraint_82', axiom, ~($lesseq($sum(length(s(jumps_ih0)), length_c1(jumps_ih_mid)), $sum(length_c2(mines10), 1)))).
tff('constraint_83', axiom, (getitem(landings(jumps_ih0), boom) | $sum($sum($sum(boom, $product(-1, length(s(jumps_ih0)))), $product(-1, length_c1(jumps_ih_mid))), 1) = 0 | $sum($sum($sum($sum(boom, $product(-1, length(s(jumps_ih0)))), $product(-1, length_c1(jumps_ih_mid))), $product(-1, length_c1(jumps_max))), 1) = 0 | getitem(landings(jumps_ih1), $sum($sum($sum(boom, $product(-1, length(s(jumps_ih0)))), $product(-1, length_c1(jumps_ih_mid))), $product(-1, length_c1(jumps_max)))))).
tff('constraint_84', axiom, getitem(mines, boom)).
