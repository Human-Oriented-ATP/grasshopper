...
(assert (! (forall ((mb t_mine_field) (x Int) (ma t_mine_field)) (= (getitem (minefield_concat ma mb) x) (or (getitem ma x) (getitem mb (+ x (* (- 1) (length_c2 ma))))))) :named constraint-40))
...
(assert (! (or (= (+ boom (* (- 1) (length_c1 jumps_max)) 1) 0) (getitem (landings jumps_ih) (+ boom (* (- 1) (length_c1 jumps_max))))) :named constraint-74))
(assert (! (getitem mines boom) :named constraint-75))
