...
(assert (! (forall ((jc t_jumps) (jb t_jumps) (ja t_jumps)) (= (jumps_concat (jumps_concat ja jb) jc) (jumps_concat ja (jumps_concat jb jc)))) :named constraint-2))
...
(assert (! (forall ((mc t_mine_field) (mb t_mine_field) (ma t_mine_field)) (= (minefield_concat (minefield_concat ma mb) mc) (minefield_concat ma (minefield_concat mb mc)))) :named constraint-9))
...
(assert (! (not (= (jumpset_merge (jumpset_merge (jumpset_merge (s jumps_ih0) (jumpset_singleton jumps_ih_mid)) (jumpset_singleton jumps_max)) (s jumps_ih1)) jumps)) :named constraint-77))
