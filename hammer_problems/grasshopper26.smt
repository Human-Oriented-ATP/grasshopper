...
(declare-const mines000 t_mine_field)
(declare-const mines001 t_mine_field)
...
(assert (! (forall ((jsb t_jump_set) (jsa t_jump_set)) (= (jumpset_merge jsa jsb) (jumpset_merge jsb jsa))) :named constraint-5))
(assert (! (forall ((jsb t_jump_set) (jsa t_jump_set) (jsc t_jump_set)) (= (jumpset_merge (jumpset_merge jsa jsb) jsc) (jumpset_merge jsa (jumpset_merge jsb jsc)))) :named constraint-6))
...
(assert (! (forall ((ma t_mine_field) (mc t_mine_field) (mb t_mine_field)) (= (minefield_concat (minefield_concat ma mb) mc) (minefield_concat ma (minefield_concat mb mc)))) :named constraint-9))
...
(assert (! (forall ((jsb t_jump_set) (jsa t_jump_set)) (= (length (jumpset_merge jsa jsb)) (+ (length jsa) (length jsb)))) :named constraint-17))
(assert (! (forall ((jsb t_jump_set) (jsa t_jump_set)) (= (number (jumpset_merge jsa jsb)) (+ (number jsa) (number jsb)))) :named constraint-18))
...
(assert (! (forall ((jsb t_jump_set) (jsa t_jump_set)) (or (not (nodup (jumpset_merge jsa jsb))) (nodup jsa))) :named constraint-32))
(assert (! (forall ((jsb t_jump_set) (jsa t_jump_set)) (or (not (nodup (jumpset_merge jsa jsb))) (nodup jsb))) :named constraint-33))
(assert (! (forall ((jsb t_jump_set) (jx t_jump) (jsa t_jump_set)) (or (not (nodup (jumpset_merge jsa jsb))) (not (contains jsa jx)) (not (contains jsb jx)))) :named constraint-34))
...
(assert (! (forall ((ma t_mine_field) (mb t_mine_field) (x Int)) (= (getitem (minefield_concat ma mb) x) (or (getitem ma x) (getitem mb (+ x (* (- 1) (length_c2 ma))))))) :named constraint-40))
...
(assert (! (not (<= (length_c2 mines00) (length_c2 mines1))) :named constraint-68))
(assert (! (= mines00 (minefield_concat mines000 mines001)) :named constraint-69))
(assert (! (= (length_c2 mines000) (length_c2 mines1)) :named constraint-70))
(assert (! (forall ((x Int)) (or (not (getitem mines000 x)) (getitem mines_un x))) :named constraint-71))
(assert (! (forall ((x Int)) (or (not (getitem mines1 x)) (getitem mines_un x))) :named constraint-72))
(assert (! (= (length_c2 mines_un) (length_c2 mines000)) :named constraint-73))
(assert (! (= (length_c2 mines_un) (length_c2 mines1)) :named constraint-74))
(assert (! (<= (count mines000) (count mines_un)) :named constraint-75))
(assert (! (<= (count mines1) (count mines_un)) :named constraint-76))
(assert (! (<= (count mines_un) (+ (count mines000) (count mines1))) :named constraint-77))
(assert (! (= jumpsr (s jumps_ih)) :named constraint-78))
(assert (! (forall ((x Int)) (or (not (getitem (landings jumps_ih) x)) (not (getitem mines_un x)))) :named constraint-79))
(assert (! (= jumps_ih (jumps_concat (jumps_singleton jumps_ih0) jumps_ihr)) :named constraint-80))
(assert (! (not (<= boom 0)) :named constraint-81))
(assert (! (not (<= size boom)) :named constraint-82))
(assert (! (or (= (+ boom (* (- 1) (length_c1 jumps_ih0)) 1) 0) (= (+ boom (* (- 1) (length_c1 jumps_ih0)) (* (- 1) (length_c1 jumps_max)) 1) 0) (getitem (landings jumps_ihr) (+ boom (* (- 1) (length_c1 jumps_ih0)) (* (- 1) (length_c1 jumps_max))))) :named constraint-83))
(assert (! (getitem mines boom) :named constraint-84))
