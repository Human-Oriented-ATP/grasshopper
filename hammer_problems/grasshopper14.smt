...
(declare-const jumps_ih0 t_jumps)
(declare-const jumps_ih_mid t_jump)
(declare-const jumps_ih1 t_jumps)
...
(assert (! (forall ((jsb t_jump_set) (jsc t_jump_set) (jsa t_jump_set)) (= (jumpset_merge (jumpset_merge jsa jsb) jsc) (jumpset_merge jsa (jumpset_merge jsb jsc)))) :named constraint-6))
...
(assert (! (not (getitem mines01 0)) :named constraint-67))
(assert (! (= (count mines0) 0) :named constraint-68))
(assert (! (= mines1 (minefield_concat (minefield_concat mines10 (minefield_singleton true)) mines11)) :named constraint-69))
(assert (! (= (count mines10) 0) :named constraint-70))
(assert (! (= jumpsr (s jumps_ih)) :named constraint-71))
(assert (! (forall ((x Int)) (or (not (getitem (landings jumps_ih) x)) (and (not (getitem mines10 x)) (not (getitem mines11 (+ x (* (- 1) (length_c2 mines10)) (- 1))))))) :named constraint-72))
(assert (! (getitem (landings jumps_ih) (length_c2 mines10)) :named constraint-73))
(assert (! (= jumps_ih (jumps_concat (jumps_concat jumps_ih0 (jumps_singleton jumps_ih_mid)) jumps_ih1)) :named constraint-74))
(assert (! (<= (length (s jumps_ih0)) (+ (length_c2 mines10) 1)) :named constraint-75))
(assert (! (not (<= (+ (length (s jumps_ih0)) (length_c1 jumps_ih_mid)) (+ (length_c2 mines10) 1))) :named constraint-76))
(assert (! (or (getitem (landings jumps_ih0) boom) (= (+ boom (* (- 1) (length (s jumps_ih0))) (* (- 1) (length_c1 jumps_ih_mid)) 1) 0) (= (+ boom (* (- 1) (length (s jumps_ih0))) (* (- 1) (length_c1 jumps_ih_mid)) (* (- 1) (length_c1 jumps_max)) 1) 0) (getitem (landings jumps_ih1) (+ boom (* (- 1) (length (s jumps_ih0))) (* (- 1) (length_c1 jumps_ih_mid)) (* (- 1) (length_c1 jumps_max))))) :named constraint-77))
(assert (! (getitem mines boom) :named constraint-78))
