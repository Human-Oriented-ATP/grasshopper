...
(assert (! (not (<= boom 0)) :named constraint-77))
(assert (! (not (<= size boom)) :named constraint-78))
(assert (! (or (getitem (landings jumps_ih0) boom) (= (+ boom (* (- 1) (length (s jumps_ih0))) (* (- 1) (length_c1 jumps_ih_mid)) 1) 0) (= (+ boom (* (- 1) (length (s jumps_ih0))) (* (- 1) (length_c1 jumps_ih_mid)) (* (- 1) (length_c1 jumps_max)) 1) 0) (getitem (landings jumps_ih1) (+ boom (* (- 1) (length (s jumps_ih0))) (* (- 1) (length_c1 jumps_ih_mid)) (* (- 1) (length_c1 jumps_max))))) :named constraint-79))
(assert (! (getitem mines boom) :named constraint-80))
