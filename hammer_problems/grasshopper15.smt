...
(assert (! (getitem (landings jumps_ih) (length_c2 mines10)) :named constraint-79))
(assert (! (or (not (<= 0 (+ (length_c2 mines10) 1))) (<= (length (s jumps_ih)) (+ (length_c2 mines10) 1))) :named constraint-80))
