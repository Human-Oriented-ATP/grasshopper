...
tff('constraint_17', axiom, ![Jsb:t_jump_set, Jsa:t_jump_set] : length(jumpset_merge(Jsa, Jsb)) = $sum(length(Jsa), length(Jsb))).
tff('constraint_18', axiom, ![Jsb:t_jump_set, Jsa:t_jump_set] : number(jumpset_merge(Jsa, Jsb)) = $sum(number(Jsa), number(Jsb))).
...
tff('constraint_47', axiom, ![Jsb:t_jump_set, Jsa:t_jump_set] : subtract(Jsa, jumpset_merge(Jsa, Jsb)) = empty_jumpset).
tff('constraint_48', axiom, ![Jsb:t_jump_set, Jsa:t_jump_set] : subtract(jumpset_merge(Jsa, Jsb), Jsa) = Jsb).
tff('constraint_49', axiom, ![Jsb:t_jump_set, Jsa:t_jump_set, Jsc:t_jump_set] : subtract(jumpset_merge(Jsa, Jsb), jumpset_merge(Jsa, Jsc)) = subtract_c1(Jsb, Jsc)).
...
tff('constraint_80', axiom, (~($lesseq(0, $sum(length_c2(mines10), 1))) | $lesseq(length(s(jumps_ih)), $sum(length_c2(mines10), 1)))).
